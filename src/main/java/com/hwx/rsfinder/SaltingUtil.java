...
public class SaltingUtil {
    ...
    public static final PColumnImpl SALTING_COLUMN = new PColumnImpl(
            //PName name,                  PName familyName, PDataType dataType, Integer maxLength, Integer scale, boolean nullable, int position, SortOrder sortOrder, Integer arrSize, byte[] viewConstant, boolean isViewReferenced, String expressionStr, boolean isRowTimestamp, boolean isDynamic) {
